...
function ManualCourseHistory({ data, setData, enableButton, setEnableButton }) {
		...
		<div className="body" style={page.body}>
			...
			<div className="content" style={page.content}>
				...
				<div className="buttons" style={page.buttons}>
					<button style={page.prevButton} onClick={previousButtonClick}>
						Previous Step
					</button>

					<button
						style={enableButton ? page.nextButton : page.disabledButton}
